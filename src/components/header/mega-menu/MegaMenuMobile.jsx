  ...
  return (
    <div className="mega-menu-wrapper">
      ...
      >
        <SidebarHeader>
          <div className="logo position-static">
            <a href="index.html">
              ...
              <img src="/images/logo/LeadGER.png" alt="home-demo" />
            </a>
          </div>
        ...
        <SidebarContent>
          <div className="">
            <a href="#" style={{borderBottom: "0.1px solid #353745"}} className="d-block py-2 border-bottom pl-4" onClick={handleClick}>Home</a>
            <a href="#about" className="d-block py-2 border-bottom pl-4" onClick={handleClick}>About</a>
            <a href="#features" className="d-block py-2 border-bottom pl-4" onClick={handleClick}>Features</a>
            <a href="#pricing" className="d-block py-2 border-bottom pl-4" onClick={handleClick}>Pricing</a>
            <a href="#contact" className="d-block py-2 pl-4" onClick={handleClick}>Contact</a>
          </div>
        </SidebarContent>
      </ProSidebar>
    </div>
...
//         <SidebarContent>
//           <Menu>
//           <a href="#" onClick={handleClick}>hello ka</a>
//             <SubMenu title="Home">
